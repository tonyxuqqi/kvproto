...
const (
	// The peer is in healthy state.
	PeerState_Normal PeerState = 0
	// When a peer has accept a snapshot, it needs to wait to apply the snapshot.
	PeerState_Applying PeerState = 1
	// The peer has been deleted.
	PeerState_Tombstone PeerState = 2
	// The peer is waiting for being merged. The state can be changed back to `Healthy` by
	// rollback prepare merge.
	PeerState_Merging PeerState = 3
	// The peer has been merged. A merged peer is the same as `Merging` except it can be
	// reverted back to healthy.
	PeerState_Merged PeerState = 4
	// When a peer is just created, it's uninitialized.
	PeerState_Uninitialized PeerState = 5
)
...
func (PeerState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{0}
}
...
func (ExtraMessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{1}
}
...
func (*SnapshotCFFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{2}
}
...
func (*SnapshotMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{3}
}
...
func (*SnapshotChunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{4}
}
...
func (*Done) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{5}
}
...
func (*KeyValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{6}
}
...
func (*RaftSnapshotData) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{7}
}
...
func (*StoreIdent) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{8}
}
...
func (*RaftLocalState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{9}
}
...
func (*RaftApplyState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{10}
}
...
func (*MergeState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{11}
}
...
type RegionLocalState struct {
	...
	// Only available when setting in raftdb side, to indicate the kv db path.
	TabletSuffix         uint64   `protobuf:"varint,5,opt,name=tablet_suffix,json=tabletSuffix,proto3" json:"tablet_suffix,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*RegionLocalState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{12}
}
...
func (m *RegionLocalState) GetIndex() uint64 {
	if m != nil {
		return m.Index
	}
	return 0
...
func (m *RegionLocalState) GetTabletSuffix() uint64 {
	if m != nil {
		return m.TabletSuffix
	}
	return 0
}
...
func (*ExtraMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_b4791b539d76da26, []int{13}
}
...
func (m *RegionLocalState) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TabletSuffix != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintRaftServerpb(dAtA, i, uint64(m.TabletSuffix))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *RegionLocalState) Size() (n int) {
	...
	if m.TabletSuffix != 0 {
		n += 1 + sovRaftServerpb(uint64(m.TabletSuffix))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *RegionLocalState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TabletSuffix", wireType)
			}
			m.TabletSuffix = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TabletSuffix |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("raft_serverpb.proto", fileDescriptor_raft_serverpb_b4791b539d76da26) }

var fileDescriptor_raft_serverpb_b4791b539d76da26 = []byte{
	// 1173 bytes of a gzipped FileDescriptorProto
	,
}
