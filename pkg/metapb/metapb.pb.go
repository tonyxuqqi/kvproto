...
func (StoreState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metapb_72be83aa843d333e, []int{0}
}
...
func (PeerRole) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metapb_72be83aa843d333e, []int{1}
}
...
func (*Store) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_72be83aa843d333e, []int{2}
}
...
func (*RegionEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_72be83aa843d333e, []int{3}
}
...
func (m *RegionBucket) Reset()         { *m = RegionBucket{} }
func (m *RegionBucket) String() string { return proto.CompactTextString(m) }
func (*RegionBucket) ProtoMessage()    {}
func (*RegionBucket) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_72be83aa843d333e, []int{4}
}
func (m *RegionBucket) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RegionBucket) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RegionBucket.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *RegionBucket) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RegionBucket.Merge(dst, src)
}
func (m *RegionBucket) XXX_Size() int {
	return m.Size()
}
func (m *RegionBucket) XXX_DiscardUnknown() {
	xxx_messageInfo_RegionBucket.DiscardUnknown(m)
}

var xxx_messageInfo_RegionBucket proto.InternalMessageInfo

func (m *RegionBucket) GetStartKey() []byte {
	if m != nil {
		return m.StartKey
	}
	return nil
...
func (m *RegionBucket) GetEndKey() []byte {
	if m != nil {
		return m.EndKey
	}
	return nil
...
type Region struct {
	...
	RegionBucket         []*RegionBucket              `protobuf:"bytes,7,rep,name=region_bucket,json=regionBucket" json:"region_bucket,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
func (*Region) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_72be83aa843d333e, []int{5}
}
...
func (m *Region) GetRegionBucket() []*RegionBucket {
	if m != nil {
		return m.RegionBucket
	}
	return nil
}
...
func (*Peer) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_72be83aa843d333e, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*RegionBucket)(nil), "metapb.RegionBucket")
...
func (m *RegionBucket) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RegionBucket) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Region) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RegionBucket) > 0 {
		for _, msg := range m.RegionBucket {
			dAtA[i] = 0x3a
			i++
			i = encodeVarintMetapb(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *RegionBucket) Size() (n int) {
	var l int
	_ = l
	l = len(m.StartKey)
	if l > 0 {
...
func (m *RegionBucket) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RegionBucket: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RegionBucket: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Region) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RegionBucket", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RegionBucket = append(m.RegionBucket, &RegionBucket{})
			if err := m.RegionBucket[len(m.RegionBucket)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("metapb.proto", fileDescriptor_metapb_72be83aa843d333e) }

var fileDescriptor_metapb_72be83aa843d333e = []byte{
	// 741 bytes of a gzipped FileDescriptorProto
	,
}
