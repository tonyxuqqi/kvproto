...
func (StoreState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metapb_176c69f8c0d45cc0, []int{0}
}
...
func (PeerRole) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metapb_176c69f8c0d45cc0, []int{1}
}
...
func (*Store) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_176c69f8c0d45cc0, []int{2}
}
...
func (*RegionEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_176c69f8c0d45cc0, []int{3}
}
...
type BucketStats struct {
	// total read (point get) in bytes of each bucket
	ReadBytes []uint64 `protobuf:"varint,1,rep,packed,name=read_bytes,json=readBytes" json:"read_bytes,omitempty"`
	// total scan in bytes of each bucket
	ScanBytes []uint64 `protobuf:"varint,2,rep,packed,name=scan_bytes,json=scanBytes" json:"scan_bytes,omitempty"`
	// total write in bytes of each bucket
	WriteBytes []uint64 `protobuf:"varint,3,rep,packed,name=write_bytes,json=writeBytes" json:"write_bytes,omitempty"`
	// total read (point get) qps of each bucket
	ReadQps []uint64 `protobuf:"varint,4,rep,packed,name=read_qps,json=readQps" json:"read_qps,omitempty"`
	// total scan qps of each bucket
	ScanQps []uint64 `protobuf:"varint,5,rep,packed,name=scan_qps,json=scanQps" json:"scan_qps,omitempty"`
	// total write qps of each bucket
	WriteQps             []uint64 `protobuf:"varint,6,rep,packed,name=write_qps,json=writeQps" json:"write_qps,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*BucketStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_176c69f8c0d45cc0, []int{4}
}
...
func (m *BucketStats) GetScanBytes() []uint64 {
	if m != nil {
		return m.ScanBytes
	}
	return nil
...
func (m *BucketStats) GetScanQps() []uint64 {
	if m != nil {
		return m.ScanQps
	}
	return nil
...
func (*Buckets) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_176c69f8c0d45cc0, []int{5}
}
...
func (*Region) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_176c69f8c0d45cc0, []int{6}
}
...
func (*Peer) Descriptor() ([]byte, []int) {
	return fileDescriptor_metapb_176c69f8c0d45cc0, []int{7}
}
...
func (m *BucketStats) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ScanBytes) > 0 {
		dAtA4 := make([]byte, len(m.ScanBytes)*10)
		var j3 int
		for _, num := range m.ScanBytes {
			for num >= 1<<7 {
	...
	if len(m.WriteBytes) > 0 {
		dAtA6 := make([]byte, len(m.WriteBytes)*10)
		var j5 int
	...
	if len(m.ScanQps) > 0 {
		dAtA10 := make([]byte, len(m.ScanQps)*10)
		var j9 int
		for _, num := range m.ScanQps {
			for num >= 1<<7 {
	...
	if len(m.WriteQps) > 0 {
		dAtA12 := make([]byte, len(m.WriteQps)*10)
		var j11 int
	...
	for iNdEx < l {
		...
		case 2:
			if wireType == 0 {
				...
				m.ScanBytes = append(m.ScanBytes, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field ScanBytes", wireType)
			}
		case 3:
			if wireType == 0 {
				var v uint64
		...
		case 5:
			if wireType == 0 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field ScanQps", wireType)
			}
		case 6:
			if wireType == 0 {
				var v uint64
...
func init() { proto.RegisterFile("metapb.proto", fileDescriptor_metapb_176c69f8c0d45cc0) }

var fileDescriptor_metapb_176c69f8c0d45cc0 = []byte{
	// 858 bytes of a gzipped FileDescriptorProto
	,
}
